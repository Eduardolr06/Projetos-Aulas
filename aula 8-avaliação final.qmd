...
ggplot(FORCAS_ARMADAS, aes(x = MS.MIL.TOTL.P1, y = country)) +
  ...
  # Outros países
  geom_col(data = filter(FORCAS_ARMADAS, pais_destacado == "Outros"),
